...
self_correction_agent.py → Codex Opus 4.6 — auto-correction des erreurs
```
...
| `backend/self_correction_agent.py` | Agent Codex Opus 4.6, auto-correction sur erreur outil |
...
## Règles absolues — voir `.Codex/rules/`
